...
if (isset($_POST['update'])) {
    ...
    if (mysqli_query($connection, $query)) {
        ...
        header('Refresh:2; url=adminviewappointment.php');
    } else {
...
<head>
    ...
    <title>Admin Update Site</title>
    <link rel="stylesheet" type="text/css" href="updateappointment.css">
</head>
<body>
    <div class="upper-container">
        <h3>Senior Care</h3>
        <img class="img" src="admin-update-image.jpg" alt="admin-update-img">
    </div>
    <div class="lower-container">
        <form action="#" method="post">
            <table align="center">
                ...
                <tr>
                    <td>Phone Number:</td>
                    <td><input class="input" type="number"  name="phoneNumber" value="<?php echo $row['phoneNumber']; ?>"></td>
                </tr>
                <tr>
                    <td>Gender: </td>
                    <td>
                ...
                <tr>
                    <td>Date: </td>
                    <td><input class="input" type="date"  name="date" value="<?php echo $row['date']; ?>"></td>
                </tr>
                <tr>
                    <td>Day: </td>
                    <td>

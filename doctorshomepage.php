...
<head>
    ...
    <link rel="stylesheet" href="doctorshome.css">
...
<body>
    <nav>
        ...
        <ul>
            ...
            <li><a href="doctor_profile.php" target="_blank">Profile</a></li>
            <li><a href="aboutus.html" target="_blank">About Us</a></li>
            <li><a href="doctorsviewappointment.php" target="_blank">View Appointment</a></li>
            <li><a href="doctorslogout.php">Log Out</a></li>
        </ul>
    </nav>
    <div>
    ...
    <div id="container">
        <div>
            <a href="checkoutservicesdoctorspage.html" target="_blank"><button type="button" class="button">
        ...
        <div>
            <a href="doctorsviewappointment.php" target="_blank"><button type="button" class="button">
